...
// docs site (docs/gen/lagotto/). Hidden — internal tooling, not a user feature —
// and the source of truth the docs drift gate checks: CI runs `lagotto gen-docs`
...
var gendocsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		frags, err := docgen.Generate(rootCmd, docgen.Options{CLIName: "lagotto"})
		if err != nil {
